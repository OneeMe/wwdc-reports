...
date: "YYYY-06-06"
tags: ["主题1", "主题2"]
thumbnail: "/images/sessions/YYYY/{CODE}.jpg"
videoUrl: "https://developer.apple.com/videos/play/wwdcYYYY/{CODE}/"
sessionId: "wwdcYYYY-{CODE}"
year: "YYYY"
relatedSessions:
  - title: "相关 session 标题"
    code: "xxx"
...
⚠️ **必须使用准确的章节名称：`## 核心内容`**（不要用"## 1. ..."或自定义名称）
...
⚠️ **必须使用准确的章节名称：`## 详细内容`**（不要用"## 2. ..."或自定义名称）
...
⚠️ **必须使用准确的章节名称：`## 核心启发`**（不要用"## 6. 实际项目里怎么用"或自定义名称）
...
⚠️ **必须使用准确的章节名称：`## 关联 Session`**（不要用"## 相关 Session"或自定义名称）

从该年份的 WWDC session 中选择 3-5 个最相关的。格式：
- [标题](/articles/wwdcYY-{code}) — 一句话描述
