...
- [Deploy machine learning models with Core ML Tools](/articles/wwdc2023-10049) — 模型转换、量化和压缩
- [Explore machine learning in Create ML](/articles/wwdc2023-10049) — 用 Create ML 交互式开发和评估模型
