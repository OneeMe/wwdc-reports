...
relatedSessions:
  ...
  - title: "App accessibility for Switch Control"
    code: "10019"
    description: "Explains how Switch Control is used and how apps can improve scanning experiences through accessibility APIs."
  - title: "Make your app visually accessible"
    code: "10020"
    description: "Starts with color, text, and visual settings to adapt interfaces to more visual needs."
  - title: "Accessibility design for Mac Catalyst"
    code: "10117"
    description: "Covers accessibility details such as keyboard support, grouping, and inspection tools when bringing iPad apps to Mac Catalyst."
  - title: "Evaluate and optimize voice interaction for your app"
    code: "10071"
    description: "Uses Siri and conversational interaction to evaluate voice entry design and assessment methods in apps."
---
