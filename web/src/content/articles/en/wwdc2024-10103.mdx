...
- [Enhance your spatial computing app with RealityKit audio](/articles/wwdc2024-10105) — Add spatial audio to spatial computing apps; this session's spaceship game sound implementation is covered there
- [Create custom hover effects in visionOS](/articles/wwdc2024-10107) — SwiftUI-level custom hover effects API, complementary to RealityKit hover effects
