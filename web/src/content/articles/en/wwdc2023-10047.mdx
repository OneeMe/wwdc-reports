...
- [Improve Core ML integration with async prediction](/articles/wwdc2023-10049) — Core ML's async prediction API for a smoother user experience with compressed models
