...
- [Simplify sign in for your tvOS apps](/articles/wwdc2021-10279) — The iPhone assisted login introduced in tvOS 15 makes TV login as easy as scanning a QR code
- [Meet Passkeys](/articles/wwdc2022-10092) — Passwordless authentication technology, already supported by tvOS 16, replacing traditional password login
- [Support multiple users in tvOS apps](/articles/wwdc2022-110384) — Basic introduction to WWDC20, understand the underlying mechanism of Runs as Current User