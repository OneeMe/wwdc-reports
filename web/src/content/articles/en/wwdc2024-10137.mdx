...
- [Track model changes with SwiftData history](/articles/wwdc2024-10152) — Learn the SwiftData History API to track model insert, update, and delete
- [Create a custom data store with SwiftData](/articles/wwdc2024-10151) — Deep dive into building custom data stores for SwiftData
- [Meet SwiftData](/articles/wwdc2024-10154) — SwiftData basics: modeling and persisting app data
- [Build complex queries with SwiftData](/articles/wwdc2024-10144) — Deep dive into SwiftData queries, predicates, and relationships
