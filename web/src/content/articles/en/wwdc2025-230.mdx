...
- [Bring widgets to new places](/articles/wwdc2025-278) — the new placements for Widgets and Live Activities in iOS 26.
- [Explore enhancements to App Intents](/articles/wwdc2025-275) — `LiveActivityIntent` is part of the App Intents family and is what powers custom button behavior.
- [What's new in widgets](/articles/wwdc2025-279) — Widget updates for the Lock Screen, Dynamic Island, and StandBy, which affect how alarms look.
