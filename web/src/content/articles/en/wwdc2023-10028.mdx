...
- [Meet SwiftUI for spatial computing](/articles/wwdc2023-10109) — How SwiftUI works in spatial computing, sharing the same AppIntents foundation as widget interactivity
- [Explore enhancements to App Intents](/articles/wwdc2023-10103) — Latest AppIntents enhancements, the engine behind widget interactivity
- [Design dynamic Live Activities](/articles/wwdc2023-10194) — Live Activities support the same Button and Toggle interactions, including on the Dynamic Island
- [What's new in AppKit](/articles/wwdc2023-10054) — Interactive widget support on macOS; desktop widgets can use Button and Toggle too
