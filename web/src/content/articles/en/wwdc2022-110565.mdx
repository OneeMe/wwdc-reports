...
- [Explore EDR on iOS](/articles/wwdc2022-10113) — EDR API supports iOS platform for the first time
- [Display EDR content with Core Image, Metal, and SwiftUI](/articles/wwdc2022-10114) — Display EDR content with SwiftUI
- [Edit and play back HDR video with AVFoundation](/articles/wwdc2020-10009) — Use AVVideoComposition to process HDR video
- [Optimize the Core Image pipeline for your video app](/articles/wwdc2020-10008) — Core Image video processing pipeline optimization