...
relatedSessions:
  - title: "Session 241 - Bring your model to Apple Intelligence"
    code: "241"
    description: "Learn the detailed capabilities and integration path for PrivateCloudComputeLanguageModel"
  ...
  - title: "Session 298 - Evaluate your AI features"
    code: "298"
    description: "Learn how to use the Evaluations framework to quantify the effects of your context-engineering strategy"
...
- [Session 241 - Bring your model to Apple Intelligence](/articles/wwdc2026-241) — Learn the detailed capabilities and integration path for PrivateCloudComputeLanguageModel
...
- [Session 298 - Evaluate your AI features](/articles/wwdc2026-298) — Learn how to use the Evaluations framework to quantify the effects of your context-engineering strategy
