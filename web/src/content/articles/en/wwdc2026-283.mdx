...
- [Explore spatial accessory input on visionOS](/articles/wwdc2025-289) — A deeper look at buttons, haptics, and input event handling for spatial accessories.
- [Explore advances in RealityKit](/articles/wwdc2026-279) — Lighting features such as Physical Surroundings Light can be combined with object tracking.
