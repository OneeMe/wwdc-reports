...
- [Improve Core ML integration with async prediction](/articles/wwdc2023-10049) — Core ML's async prediction API so model inference doesn't block the main thread
