...
relatedSessions:
  ...
  - title: "Build customized ML models with Metal Performance Shaders Graph"
    code: "10050"
...
- [Accelerate machine learning with Metal](/articles/wwdc2023-10050) — WWDC22 的 Metal ML 加速基础
- [Build customized ML models with Metal Performance Shaders Graph](/articles/wwdc2023-10050) — 用 MPSGraph 构建自定义 ML 模型
