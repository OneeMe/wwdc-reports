...
- [Meet MusicKit for Swift](/articles/wwdc2021-10294) — MusicKit provides music playback and library management; combined with Music Understanding analysis, it can support complete music apps
...
- [Explore machine learning on Apple platforms](/articles/wwdc2024-10223) — Learn about the underlying mechanisms of on-device ML on Apple devices and understand the inference optimization strategy of the Music Understanding framework
