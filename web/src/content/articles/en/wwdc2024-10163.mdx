...
relatedSessions:
  - title: "Bring your machine learning and AI models to Apple silicon"
    code: "10159"
    description: "Learn how to optimize machine learning models to use the compute power of Apple silicon"
  - title: "Deploy machine learning and AI models on-device with Core ML"
    code: "10161"
    description: "Learn new ways to optimize speed and memory performance when deploying ML models on-device"
  - title: "Build a great Lock Screen camera capture experience"
    code: "10204"
    description: "Explore how to provide camera capture features on the Lock Screen with the Lock Screen Camera Capture API"
  - title: "What's new in Create ML"
    code: "10183"
    description: "Explore Create ML updates, including the visionOS object tracking model template"
---
