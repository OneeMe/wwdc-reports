...
relatedSessions:
  - title: "Export HDR media in your app with AVFoundation"
    code: "10010"
    description: "Complements the HDR media export workflow, covering AVAssetExportSession, AVAssetWriter, and platform support limits."
  - title: "Optimize the Core Image pipeline for your video app"
    code: "10008"
    description: "Explains Core Image pipelines, CIContext reuse, Metal queues, and filter performance in video apps."
  - title: "Build Metal-based Core Image kernels with Xcode"
    code: "10021"
    description: "Shows how to integrate Core Image kernels written in Metal Shading Language into an app."
