...
- [Meet CloudKit Console](/articles/wwdc2021-10117) — A new web version of CloudKit management tool
- [Build dynamic iOS apps with the Create ML framework](/articles/wwdc2021-10037) — Train personalized machine learning models on the device
