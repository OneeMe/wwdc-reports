...
- [Build custom workouts with WorkoutKit](/articles/wwdc2023-10016) — WorkoutKit custom training structure, used with CMBatchedSensorManager
- [What's new in HealthKit](/articles/wwdc2022-10005) — HealthKit new features, sports data storage and sharing
- [Use Core ML Tools for machine learning model compression](/articles/wwdc2023-10047) — Using high-frequency sensor data for machine learning model training
