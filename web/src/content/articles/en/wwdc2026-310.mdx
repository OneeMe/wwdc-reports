...
- [Develop for Shortcuts and Spotlight with App Intents](/articles/wwdc2026-345) - A foundation-level introduction to App Intents; every Entity and Query definition in session 310 depends on this framework
- [What's new in App Intents](/articles/wwdc2026-343) - Advanced App Intents usage, including more configuration options for Entity types
