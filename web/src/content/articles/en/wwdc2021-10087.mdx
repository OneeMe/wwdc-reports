...
- [Ultimate application performance survival guide](/articles/wwdc2021-10181) — Learn more about the various reasons why apps are terminated by the system and repair strategies
- [Identify trends with the Power and Performance API](/articles/wwdc2020-10057) — Detailed explanation of WWDC20’s App Store Connect API performance indicators
- [Triage TestFlight crashes in Xcode Organizer](/articles/wwdc2021-10203) — Diagnosing TestFlight crash reports with Xcode
- [Reduce networking delays for a more responsive app](/articles/wwdc2022-10078) — Practical tips to improve application responsiveness
