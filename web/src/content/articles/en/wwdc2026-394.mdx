...
- **[Apple Design Awards](https://developer.apple.com/design/awards/)** — Design analysis of the year's best apps and games, a practical reference for motion and interaction
- **[What's new in SwiftUI](/articles/wwdc2026-269)** — A must-watch framework update after SOTU, covering the latest UI-layer capabilities
