...
relatedSessions:
  - title: "Keynote"
    code: "101"
    description: "The WWDC25 main keynote, covering new product and system features."
  - title: "Meet Liquid Glass"
    code: "219"
    description: "Design principles and implementation details for the new Liquid Glass design language."
  - title: "Meet the Foundation Models framework"
    code: "286"
    description: "A Swift framework for on-device large language models, supporting Generable and tool calling."
---
