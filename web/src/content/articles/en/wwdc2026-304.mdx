...
- [Capture High-Quality Photos Using Video Formats](/articles/wwdc2021-10247) - Core Image RAW processing that connects with this session's RAW and ProRAW capture discussion.
- [Create a More Responsive Camera Experience](/articles/wwdc2023-10105) - Instruments responsiveness analysis tools that can measure the real effects of deferred processing and responsive shutter behavior.
