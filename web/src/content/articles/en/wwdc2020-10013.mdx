...
relatedSessions:
  - title: "Discover ray tracing with Metal"
    code: "10012"
    description: "Introduces Metal ray tracing APIs, acceleration structures, and ray intersection workflows in compute kernels."
  - title: "Build GPU binaries with Metal"
    code: "10615"
    description: "Explains the Metal shader compilation model, binary archives, and dynamic library workflows."
  - title: "Debug GPU-side errors in Metal"
    code: "10616"
    description: "Uses Xcode 12 to report and locate GPU-side errors, including shader validation and command buffer logs."
  - title: "Optimize Metal apps and games with GPU counters"
    code: "10603"
    description: "Uses Xcode GPU counters to locate idle or overloaded pipeline stages in Metal workloads."
  - title: "Harness Apple GPUs with Metal"
    code: "10602"
    description: "Explains how Apple GPUs and tile-based deferred rendering affect Metal workload performance."
---
