...
- [What's new in App Intents](/articles/wwdc2024-10134) - Understanding the new App Intents APIs is the prerequisite for writing tests
- [Go further with App Intents](/articles/wwdc2026-343) - Explore advanced App Intents usage and richer testing scenarios
- [Design great widgets](/articles/wwdc2020-10103) - Widgets also depend on App Intents to provide data, so the testing framework applies there too
