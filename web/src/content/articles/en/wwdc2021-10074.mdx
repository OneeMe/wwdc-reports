...
- [Discover geometry-aware audio with the Physical Audio Spatialization Engine (PHASE)](/articles/wwdc2021-10079) — Geometry-aware audio in ARKit
- [Render with Metal](https://developer.apple.com/videos/play/wwdc2019/601/) — Metal rendering pipeline, the basis for writing shaders for CustomMaterial
