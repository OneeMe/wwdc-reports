...
([12:19](https://developer.apple.com/videos/play/wwdc2020/10081/?time=739)) Crash diagnostics are represented by `MXCrashDiagnostic`. Every time the app crashes, MetricKit provides exception information, termination reason, virtual memory region information under bad access crashes, and the backtrace.
