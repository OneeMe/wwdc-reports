...
- [What's new in privacy](/articles/wwdc2025-265) — changes to the privacy boundary, useful for understanding how managed configuration is delivered safely under the privacy framework.
- [Streamline sign-in with passkey upgrades and credential managers](/articles/wwdc2025-279) — the authentication side of the story; combine it with the identity capabilities ManagedApp provides.
