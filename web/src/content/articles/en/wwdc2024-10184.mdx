...
- [Explore structured concurrency in Swift](/articles/wwdc2024-10170) — Systematic coverage of Task, async/await, and the actor concurrency model
...
- [Expand on Swift macros](/articles/wwdc2024-10169) — Compile-time code generation with macros—another language extension beyond property wrappers and result builders
