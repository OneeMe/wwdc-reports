...
relatedSessions:
  - title: "Make your app visually accessible"
    code: "10020"
    description: "Checks visual accessibility through color, text, Button Shapes, Smart Invert, and Large Text."
  - title: "Create a seamless speech experience in your apps"
    code: "10022"
    description: "Uses AVSpeechSynthesizer and assistive technology announcements to complete the speech experience."
  - title: "VoiceOver efficiency with custom rotors"
    code: "10116"
    description: "Uses custom rotors to help VoiceOver users navigate complex interfaces by app-specific dimensions."
  - title: "Accessibility design for Mac Catalyst"
    code: "10117"
    description: "Extends iPad app accessibility foundations to Mac Catalyst, covering keyboard, mouse, grouping, and testing details."
  - title: "Build for the iPadOS pointer"
    code: "10093"
    description: "Uses iPadOS pointer interaction APIs to improve experiences for mice, trackpads, and other indirect input devices."
---
