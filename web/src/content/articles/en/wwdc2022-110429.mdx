...
- [Explore ARKit 4](/articles/wwdc2020-10611) — Introduction to the LiDAR Scanner API in ARKit
- [Capturing Depth in iPhone Photography](https://developer.apple.com/videos/play/wwdc2017/507/) — A detailed guide to capturing depth data using AVFoundation
- [Master Picture in Picture on tvOS](/articles/wwdc2020-10176) — Implement picture-in-picture function in video calling applications
- [Discover advancements in iOS camera capture: Depth, focus, and multitasking](/articles/wwdc2022-110429) — Best practices for using the camera in multitasking scenarios