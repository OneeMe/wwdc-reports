...
- [Bring advanced speech-to-text to your app with SpeechAnalyzer](/articles/wwdc2025-274) — SpeechAnalyzer API + new speech models, specialized for long audio and far-field
...
- [What's new in BNNS Graph](/articles/wwdc2025-220) — BNNS Graph Builder for building real-time ML / signal processing pipelines on CPU
