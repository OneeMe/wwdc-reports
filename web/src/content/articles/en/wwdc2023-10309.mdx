...
- [Build widgets for the Smart Stack on Apple Watch](/articles/wwdc2023-10029) — The accompanying code practice session teaches you step by step how to implement Smart Stack widgets
- [Bring widgets to new places](/articles/wwdc2023-10027) — A complete guide to WidgetKit cross-platform extensions
- [Design dynamic Live Activities](/articles/wwdc2023-10194) — The design concept of real-time activities is complementary to widgets
- [Meet SwiftUI for spatial computing](/articles/wwdc2023-10109) — Learn about Apple’s latest UI framework design concepts
