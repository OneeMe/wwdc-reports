...
- [Set the scene with SwiftUI in visionOS](/articles/wwdc2025-208) — how to lay out shared and full space scenes in SwiftUI, useful for a spatial accessory app's window layout.
