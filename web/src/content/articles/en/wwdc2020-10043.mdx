...
([05:28](https://developer.apple.com/videos/play/wwdc2020/10043/?time=328)) If a montage video contains multiple actions, use CSV or JSON to mark the start and end time of each action. The official code snippet gives the JSON structure:```json
[
    {
...
([14:05](https://developer.apple.com/videos/play/wwdc2020/10043/?time=845)) The model receives the human pose extracted by Vision, and the original video first undergoes pose extraction. The minimum entry point is `VNDetectHumanBodyPoseRequest`:```swift
import Vision
...
([14:10](https://developer.apple.com/videos/play/wwdc2020/10043/?time=850)) When processing a video file, you can hand this request to `VNVideoProcessor`:```swift
import Vision
...
([14:26](https://developer.apple.com/videos/play/wwdc2020/10043/?time=866)) When processing pictures or camera frames, Session uses `VNImageRequestHandler`:```swift
import Vision
let request = VNDetectHumanBodyPoseRequest()
...
([14:57](https://developer.apple.com/videos/play/wwdc2020/10043/?time=897)) The action classification model exported by Create ML receives a three-dimensional multi-array. The posture of each frame is first converted into `[1, 3, 18]`, and then 60 frames are assembled into `[60, 3, 18]`:```swift
import Vision
import CoreML
...
([16:27](https://developer.apple.com/videos/play/wwdc2020/10043/?time=987)) The Xcode demo encapsulates pose extraction, window caching and prediction in `Predictor`:```swift
import Foundation
import CoreML
import Vision
