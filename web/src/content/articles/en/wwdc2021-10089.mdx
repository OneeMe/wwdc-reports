...
- [What's new in HealthKit](/articles/wwdc2021-10001) — All updates to HealthKit in iOS 15
- [Build a research and care app, part 1](/articles/wwdc2021-10068) — Build a clinical research app using ResearchKit and CareKit
- [Handling FHIR without getting burned](/articles/wwdc2021-10060) — Best practices for correct handling of FHIR data
