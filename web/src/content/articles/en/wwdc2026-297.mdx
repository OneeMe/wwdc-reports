...
- [Bring your app to Siri](/articles/wwdc2026-344) - An introduction to App Intents basics. If you have not worked with App Entity or Intent yet, start here.
- [What's new in App Intents](/articles/wwdc2026-345) - Learn about new App Intents features, including more ways to use UnionValue.
