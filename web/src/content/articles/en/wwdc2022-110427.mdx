...
- [Demystify parallelization in Xcode builds](/articles/wwdc2022-110362) — In-depth understanding of Xcode build parallelization mechanism
- [Link fast: Improve build and launch times](/articles/wwdc2022-110363) — Linker optimization, improve build and launch speed
- [Track down hangs with Xcode and on-device detection](/articles/wwdc2022-110391) — Locate and fix application hangs.
