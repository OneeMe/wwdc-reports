...
- [Bring your app's core features to users with App Intents](/articles/wwdc2023-10171) — Technical implementation details of the App Intents framework
- [Design dynamic Live Activities](/articles/wwdc2023-10184) — Design guide for quick operations combined with real-time activities
- [Build a great Lock Screen experience](/articles/wwdc2023-10199) — Co-design of lock screen widgets and shortcut operations