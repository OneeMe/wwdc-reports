...
relatedSessions:
  ...
  - title: "Metal debugging and profiling update"
    code: "243"
    description: "The latest updates to Metal developer tools"
  ...
  - title: "Diagnostics and crash analysis"
    code: "379"
    description: "App diagnostics and crash analysis"
---
...
- [Metal debugging and profiling update](/articles/wwdc2026-243) — The latest updates to Metal developer tools
- [Optimize your game with Instruments](/articles/wwdc2026-243) — Best practices for performance analysis with Instruments
- [Meet the new MetricKit](/articles/wwdc2026-379) — A deep dive into MetricKit
- [Diagnostics and crash analysis](/articles/wwdc2026-379) — App diagnostics and crash analysis
