...
- [SwiftData: Dive into inheritance and schema migration](/articles/wwdc2025-291) — A deeper look at model inheritance and schema migration; the Goal inheritance design is based on this approach
