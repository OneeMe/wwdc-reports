...
relatedSessions:
  - title: "What's new in HTTP Live Streaming"
    code: "303"
    description: "HLS live streams are one of the core scenarios for AI-generated subtitles, and the latest HLS features can help optimize streaming playback"
...
- [What's new in HTTP Live Streaming](/articles/wwdc2026-303) - HLS live streams are one of the core scenarios for AI-generated subtitles, and the latest HLS features can help optimize streaming playback
