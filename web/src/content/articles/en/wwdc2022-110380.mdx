...
- [Make a great SharePlay experience](/articles/wwdc2022-10139) — Design principles and best practices for building great SharePlay experiences
- [Coordinate media playback in Safari with Group Activities](/articles/wwdc2021-10189) — Basic implementation guide for SharePlay coordinated playback
- [Explore HLS variants in AVFoundation](/articles/wwdc2021-10143) — HLS multi-bitrate playlist and dynamic content scheduling
- [What's new in AVFoundation](/articles/wwdc2021-10146) — AVFoundation's asynchronous API and reactive media processing