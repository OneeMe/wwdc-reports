...
- [What's new in web accessibility](/articles/wwdc2022-10153) — latest accessibility features and frameworks in iOS 17, iPadOS 17, macOS Sonoma
- [Eliminate animation hitches with XCTest](/articles/wwdc2020-10077) — techniques for writing better tests, including UI and unit test strategies
- [Meet Assistive Access](/articles/wwdc2023-10032) — how Apple Store accessibility features enhance shopping for users with disabilities
- [The process of inclusive design](/articles/wwdc2021-10304) — designing interfaces for everyone, including visual, motor, and cognitive disability users
- [SwiftUI Accessibility: Beyond the basics](/articles/wwdc2021-10119) — how SwiftUI makes accessible interfaces easy and how to customize the accessibility experience
