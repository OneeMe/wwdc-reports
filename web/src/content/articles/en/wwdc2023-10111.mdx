...
relatedSessions:
  ...
  - title: "Take SwiftUI to the next dimension"
    code: "10113"
    description: "Use 3D content and volumes in SwiftUI"
  - title: "Build spatial experiences with RealityKit"
    code: "10080"
    description: "A deep dive into RealityKit"
  - title: "Evolve your ARKit app for spatial experiences"
    code: "10091"
    description: "New ARKit capabilities for hand tracking and spatial positioning"
---
...
- [Take SwiftUI to the next dimension](/articles/wwdc2023-10113) — More ways to use 3D content, Model3D, and RealityView in SwiftUI
...
- [Evolve your ARKit app for spatial experiences](/articles/wwdc2023-10091) — ARKit for hand tracking, plane detection and spatial positioning on visionOS