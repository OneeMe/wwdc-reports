...
- [What's new in App Store Connect](/articles/wwdc2023-10053) — App Store Connect received multiple updates at WWDC23, including more flexible product page management and analytics tools
- [Explore App Store Connect for SwiftUI](/articles/wwdc2023-10054) — The App Store Connect API added a Swift client for managing app metadata directly in Swift projects
