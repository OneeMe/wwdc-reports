...
- [What's new in App Store pricing](/articles/wwdc2023-10065) — Dive into pricing updates and App Store Connect API pricing endpoints
...
- [Simplify distribution in Xcode and Xcode Cloud](/articles/wwdc2023-10197) — Simplify the distribution process for Xcode and Xcode Cloud
- [Explore testing in-app purchases](/articles/wwdc2023-10075) — StoreKit tests, sandbox tests, and TestFlight tests
