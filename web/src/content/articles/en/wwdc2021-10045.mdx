...
- [Meet MusicKit for Swift](/articles/wwdc2021-10194) — ShazamKit 返回的媒体项可与 MusicKit 强类型对象对接
- [Classify sound in video with Sound Analysis](/articles/wwdc2021-10036) — 如果需要识别声音类别（笑声、掌声等），用 SoundAnalysis 框架
