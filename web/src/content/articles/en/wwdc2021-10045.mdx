...
- [Meet MusicKit for Swift](/articles/wwdc2021-10294) — The media items returned by ShazamKit can be connected to MusicKit strongly typed objects
- [Discover built-in sound classification in SoundAnalysis](/articles/wwdc2021-10036) — If you need to identify sound categories (laughter, applause, etc.), use the SoundAnalysis framework
