...
relatedSessions:
  - title: "Meet Liquid Glass"
    code: "219"
    description: "Design principles, behavior, and usage patterns for Liquid Glass"
  - title: "Build an AppKit app with the new design"
    code: "310"
    description: "Apply the new design system in AppKit apps"
  - title: "Create icons with Icon Composer"
    code: "361"
    description: "Create icons for the new system with Icon Composer"
  - title: "Elevate the design of your iPad app"
    code: "208"
    description: "Layout practices for iPad apps under the new design language"
---
