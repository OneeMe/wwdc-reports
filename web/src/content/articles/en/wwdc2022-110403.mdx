...
- [Accelerate networking with HTTP/3 and QUIC](/articles/wwdc2021-10094) — Improve network transmission efficiency and work with Background Assets to optimize large file downloads
- [What's new in SwiftUI](/articles/wwdc2022-10052) — Use SwiftUI to build application interfaces that require preloaded resources
- [Meet SwiftData](/articles/wwdc2023-10187) — Manage application data models and work with resource downloads