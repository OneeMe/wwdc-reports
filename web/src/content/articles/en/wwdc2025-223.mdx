...
- [Share visionOS experiences with nearby people](/articles/wwdc2025-258) — high-level SharePlay APIs for sharing spatial experiences with nearby devices.
...
- [Get started with HealthKit in visionOS](/articles/wwdc2025-205) — another sensitive-data access scenario on visionOS; compare its permission design with this session.
- [Explore spatial accessory input on visionOS](/articles/wwdc2025-216) — visionOS 26 input device extensions, paired with Window Follow Mode for enterprise on-site scenarios.
