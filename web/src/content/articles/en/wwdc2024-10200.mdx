...
- [Create practical workflows in Xcode Cloud](/articles/wwdc2024-10201) — Real-world scenarios for creating and configuring Xcode Cloud workflows
- [Customize your advanced Xcode Cloud workflows](/articles/wwdc2024-10203) — Deep dive into custom scripts and advanced workflow configuration
- [Meet Swift OpenAPI Generator](/articles/wwdc2024-10156) — Generate Swift code from OpenAPI specs—the tool used for the session's API client
- [Meet Xcode Cloud](/articles/wwdc2024-10234) — Xcode Cloud introduction: concepts and getting started
