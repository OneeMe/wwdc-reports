...
relatedSessions:
  - title: "Squeeze the most out of Apple Pencil"
    code: "10214"
    year: "2024"
    description: "Introduces Apple Pencil squeeze gestures and tool picker interactions from WWDC24"
  - title: "Introducing PencilKit"
    code: "221"
    year: "2019"
    description: "Introduces the PencilKit canvas and tool picker from WWDC19"
  - title: "Dive deeper into Writing Tools"
    code: "265"
    description: "Writing Tools lets users proofread, rewrite, and transform text directly in text controls"
  - title: "Enhance child safety with PermissionKit"
    code: "293"
    description: "Use PermissionKit to enhance child communication safety in communication apps"
---
...
- [Introducing PencilKit](https://developer.apple.com/videos/play/wwdc2019/221/) — an introduction to the PencilKit canvas and tool picker
