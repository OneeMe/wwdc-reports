...
- [Use async/await with URLSession](/articles/wwdc2021-10095) — New features and best practices in URLSession
- [Get ready for iCloud Private Relay](/articles/wwdc2021-10096) — Network impact of iCloud Private Relay
- [Boost performance and security with modern networking](/articles/wwdc2020-10111) — New capabilities for macOS network extensions
