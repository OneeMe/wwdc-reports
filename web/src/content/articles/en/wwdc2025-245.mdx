...
relatedSessions:
  - title: "Code-along: Elevate an app with Swift concurrency"
    code: "270"
    description: "Refactor a real app with Swift concurrency"
  - title: "Embracing Swift concurrency"
    code: "268"
    description: "Understand the design trade-offs in Swift 6.2 concurrency"
  - title: "Explore Swift performance"
    code: "10217"
    year: "2024"
    description: "The underlying principles behind performance features such as InlineArray and Span"
  - title: "Meet Containerization"
    code: "346"
    description: "An open source container runtime project written in Swift"
---
...
- [Explore Swift performance](/articles/wwdc2024-10217) — the underlying mechanics of InlineArray, Span, and memory safety
