...
- [Explore computer vision APIs](/articles/wwdc2020-10071) — A comprehensive introduction to Vision at WWDC20 to understand the overall capabilities of Vision
- [Vision and Core Image](/articles/wwdc2020-10073) — Vision from WWDC20 is used in conjunction with Core Image, including document preprocessing technology
