...
- [Enhance your spatial computing app with RealityKit audio](/articles/wwdc2024-10105) — 为空间计算应用添加空间音频，本 session 飞船游戏的音效实现在此讲解
- [Create custom hover effects in visionOS](/articles/wwdc2024-10107) — SwiftUI 层面的自定义 hover effects API，与 RealityKit 的 hover effects 互补
