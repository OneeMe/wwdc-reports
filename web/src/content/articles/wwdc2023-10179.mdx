...
- [Build custom workouts with WorkoutKit](/articles/wwdc2023-10016) — WorkoutKit 自定义训练结构，与 CMBatchedSensorManager 配合使用
- [What's new in HealthKit](/articles/wwdc2022-10005) — HealthKit 新功能，运动数据存储与共享
- [Use Core ML Tools for machine learning model compression](/articles/wwdc2023-10047) — 将高频传感器数据用于机器学习模型训练
