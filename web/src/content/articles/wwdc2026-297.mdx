...
- [Bring your app to Siri](/articles/wwdc2024-10133) — App Intents 基础入门，如果你还没接触过 App Entity 和 Intent，先看这场。
- [What's new in App Intents](/articles/wwdc2024-10134) — 了解 App Intents 的新特性，包括 UnionValue 的更多用法。
- [What's new in Vision](/articles/wwdc2022-10024) — 深入了解 Vision 框架的图像处理能力，包括 feature print、文本识别、条码扫描等。
