...
- [Compose custom layouts with SwiftUI](/articles/wwdc2026-322) — 自定义 Layout 替代几何变化回调
- [Stacks, Grids, and Outlines in SwiftUI](/articles/wwdc2026-269) — SwiftUI 布局基础，本 session 的前置知识
