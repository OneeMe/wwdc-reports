...
- [Discover geometry-aware audio with the Physical Audio Spatialization Engine (PHASE)](/articles/wwdc2021-10079) — ARKit 中的几何感知音频
- [Render with Metal](https://developer.apple.com/videos/play/wwdc2019/601/) — Metal 渲染管线，为 CustomMaterial 编写 shader 的基础
