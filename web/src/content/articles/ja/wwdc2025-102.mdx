...
relatedSessions:
  - title: "Keynote"
    code: "101"
    description: "WWDC25 のメインステージ発表会。プロダクトとシステムの新機能を紹介します。"
  - title: "Meet Liquid Glass"
    code: "219"
    description: "新しいデザイン言語 Liquid Glass の設計原則と実装の詳細。"
  - title: "Meet the Foundation Models framework"
    code: "286"
    description: "オンデバイス LLM の Swift フレームワーク。Generable と Tool calling に対応。"
---
