...
year: "2026"
relatedSessions:
  - title: "visionOS のオブジェクトトラッキングを探る"
    code: "282"
    description: "オブジェクトトラッキングの基礎入門です。今回の強化を理解する前に見ると役立ちます。"
  ...
  - title: "Create ML とオブジェクトトラッキング"
    code: "252"
    description: "Reality Composer Pro 3 におけるオブジェクトトラッキングのトレーニングワークフローです。"
...
- [visionOS のオブジェクトトラッキングを探る](/articles/wwdc2026-282) — オブジェクトトラッキングの基礎入門です。今回の強化を理解する前に見ると役立ちます。
...
- [Create ML とオブジェクトトラッキング](/articles/wwdc2026-252) — Reality Composer Pro 3 におけるオブジェクトトラッキングのトレーニングワークフローです。
