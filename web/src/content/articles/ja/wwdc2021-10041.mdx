...
- [コンピューター ビジョン API を探索する](/articles/wwdc2020-10673) — Vision の全体的な機能を理解するための、WWDC20 での Vision の包括的な紹介
- [ビジョンとコア イメージ](/articles/wwdc2020-10673) - WWDC20 のビジョンは、ドキュメント前処理テクノロジを含むコア イメージと組み合わせて使用​​されます。
