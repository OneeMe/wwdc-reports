...
relatedSessions:
  - title: "Meet the Foundation Models framework"
    code: "286"
    description: "Foundation Models フレームワークの入門紹介。Guided Generation と Tool Calling を含みます。"
  - title: "Deep dive into the Foundation Models framework"
    code: "301"
    description: "Foundation Models フレームワークの高度な使い方。ストリーミング出力とツール呼び出しを扱います。"
  - title: "Code-along: Bring on-device AI to your app using the Foundation Models framework"
    code: "259"
    description: "Foundation Models で実際の App を改造する Code-along チュートリアル。"
  - title: "Discover machine learning & AI frameworks on Apple platforms"
    code: "360"
    description: "Apple プラットフォーム上の各種 ML/AI フレームワークを俯瞰する入門。"
---
