...
relatedSessions:
  ...
  - title: "プライバシー保護 ML"
    code: "324"
    description: "Core AI のプライバシー保護機械学習と、Apple のオンデバイス ML 全体の戦略"
  - title: "In-App Purchase"
    code: "210"
    description: "Trust Insights と組み合わせて高価値取引を保護できる、アプリ内課金の最新実践"
  - title: "デバイス管理"
    code: "206"
    description: "エンタープライズデバイス管理と、企業環境でセキュリティポリシーを展開する方法"
---
...
- [プライバシー保護 ML](/articles/wwdc2026-324) — Core AI のプライバシー保護機械学習と、Apple のオンデバイス ML 全体の戦略
- [In-App Purchase](/articles/wwdc2026-210) — Trust Insights と組み合わせて高価値取引を保護できる、アプリ内課金の最新実践
- [デバイス管理](/articles/wwdc2026-206) — エンタープライズデバイス管理と、企業環境でセキュリティポリシーを展開する方法
