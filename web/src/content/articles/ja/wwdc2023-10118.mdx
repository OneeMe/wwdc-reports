...
- [Rediscover Safari developer features](/articles/wwdc2023-10262) — デバイスペアリングとレスポンシブデザインモードを含む Safari 開発者機能の総合アップデート
- [What's new in CSS](/articles/wwdc2023-10121) — コンテナクエリやカスケードレイヤーなど CSS の新機能
- [What's new in Safari and WebKit](/articles/wwdc2022-10048) — WebKit エンジンの新機能と改善
- [Meet Safari Web Extensions](/articles/wwdc2020-10665) — Safari Web 拡張機能の開発
- [Explore WKWebView additions](/articles/wwdc2021-10032) — WKWebView の新 API と機能
