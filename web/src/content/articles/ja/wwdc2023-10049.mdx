...
- [Improve Core ML integration with async prediction](/articles/wwdc2023-10049) — モデル変換、量子化、圧縮
- [Discover machine learning enhancements in Create ML](/articles/wwdc2023-10044) — Create ML での対話的開発と評価
