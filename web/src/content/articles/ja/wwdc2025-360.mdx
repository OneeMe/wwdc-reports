...
relatedSessions:
  - title: "Meet the Foundation Models framework"
    code: "286"
    description: "Foundation Models フレームワークの入門 session。session、guided generation、tool calling を詳しく解説"
  - title: "Bring advanced speech-to-text to your app with SpeechAnalyzer"
    code: "274"
    description: "新しい SpeechAnalyzer API が SFSpeechRecognizer を置き換え、長時間音声と遠距離収録に特化"
  - title: "Explore large language models on Apple silicon with MLX"
    code: "298"
    description: "MLX を使って Apple Silicon 上で DeepSeek-R1 などの大規模モデルを実行"
---
