...
- [Bring advanced speech-to-text to your app with SpeechAnalyzer](/articles/wwdc2025-277) — SpeechAnalyzer API + 新音声モデル、長音声と遠方専用
...
- [What's new in BNNS Graph](/articles/wwdc2025-276) — BNNS Graph Builder で CPU 上にリアルタイム ML / 信号処理パイプラインを構築
