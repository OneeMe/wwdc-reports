...
- [What's new in HealthKit](/articles/wwdc2022-10005) — WorkoutKit と組み合わせてトレーニングデータを取得する HealthKit の最新機能と更新を確認
- [What's new in watchOS 8](/articles/wwdc2021-10002) — ワークアウト app の改善を含む watchOS のシステムレベルの新機能を探索
