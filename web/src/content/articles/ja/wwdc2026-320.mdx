...
year: "2026"
relatedSessions:
  - title: "visionOS の没入型環境をデザインする"
    code: "250"
    description: "リアルな 3D 環境を作るためのデザイン原則を学びます"
  - title: "空間 Web の新機能"
    code: "234"
    description: "モデルアニメーションのタイムラインや、さらに多くの空間 Web API を詳しく学びます"
  - title: "visionOS のカスタム環境を最適化する"
    code: "280"
    description: "3D アセット最適化の上級ガイドです"
...
- [visionOS の没入型環境をデザインする](/articles/wwdc2026-250) - リアルな 3D 環境を作るためのデザイン原則を学びます
- [空間 Web の新機能](/articles/wwdc2026-234) - モデルアニメーションのタイムラインや、さらに多くの空間 Web API を詳しく学びます
- [visionOS のカスタム環境を最適化する](/articles/wwdc2026-280) - 3D アセット最適化の上級ガイドです
