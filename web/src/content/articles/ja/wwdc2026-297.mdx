...
- [アプリをSiriへ対応させる](/articles/wwdc2024-10133) - App Intentsの基礎入門です。App EntityやIntentにまだ触れたことがない場合は、まずこのSessionから見るとよいでしょう。
- [App Intentsの新機能](/articles/wwdc2024-10134) - UnionValueのさらなる使い方を含む、App Intentsの新機能を学びます。
