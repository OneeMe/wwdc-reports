...
relatedSessions:
  - title: "Build spatial experiences with RealityKit"
    code: "10080"
    description: "RealityKit の基礎：Entity、Component、System、RealityView"
  ...
  - title: "Go beyond the window with SwiftUI"
    code: "10111"
    description: "SwiftUI のイマーシブ空間とシーンタイプ"
---
...
- [Go beyond the window with SwiftUI](/articles/wwdc2023-10111) — SwiftUI の没入空間とシーンタイプ
