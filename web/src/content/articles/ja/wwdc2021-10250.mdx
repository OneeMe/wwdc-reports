...
The past practice was to draw an ordinary SVG in the design tool and then use it as an image.これでは SF シンボルの利点が失われます。 Icons may not necessarily align with the text baseline, nor may they follow changes in bold text, different control sizes, and system appearance.
