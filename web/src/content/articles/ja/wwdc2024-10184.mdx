...
- [Explore structured concurrency in Swift](/articles/wwdc2021-10134) — Task、async/await、actor 並行モデルの体系的解説
- [Demystify explicitly built modules](/articles/wwdc2024-10171) — Swift モジュールコンパイル機構を含む Xcode 16 ビルドシステムの変化
- [Expand on Swift macros](/articles/wwdc2023-10167) — マクロによるコンパイル時コード生成 — プロパティラッパーと result builder 以外の言語拡張手段
