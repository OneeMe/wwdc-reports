...
relatedSessions:
  - title: "Build Metal-based Core Image kernels with Xcode"
    code: "10021"
    description: "Metal Shading Language で書いた Core Image kernel を App に統合して読み込む方法を説明します。"
  ...
  - title: "Edit and play back HDR video with AVFoundation"
    code: "10009"
    description: "AVFoundation で HDR 動画を編集・再生し、Core Image フィルタと組み合わせて映像を処理する方法を説明します。"
