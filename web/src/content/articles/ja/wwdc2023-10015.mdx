...
- [What's new in App Store Connect](/articles/wwdc2023-10117) — App Store Connect は WWDC23 で複数の更新を受け、より柔軟なプロダクトページ管理と分析ツールが追加されました
- [Explore App Store Connect for spatial computing](/articles/wwdc2023-10012) — App Store Connect API に Swift クライアントが追加され、Swift プロジェクトで App メタデータを直接管理できます
