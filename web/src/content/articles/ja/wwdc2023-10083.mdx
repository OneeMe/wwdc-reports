...
relatedSessions:
  - title: "Explore materials in Reality Composer Pro"
    code: "10202"
    description: "Reality Composer Pro の Shader Graph マテリアルシステムを詳しく理解します。"
  - title: "Work with Reality Composer Pro content in Xcode"
    code: "10273"
    description: "Xcode で Reality Composer Pro コンテンツを読み込み、制御するコード実践。"
  - title: "Meet ARKit for spatial computing"
    code: "10082"
    description: "visionOS 上の ARKit の新しい API と、Reality Composer Pro コンテンツとの連携。"
