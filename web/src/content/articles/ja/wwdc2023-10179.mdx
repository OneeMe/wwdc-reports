...
- [Building custom workouts with WorkoutKit](/articles/wwdc2023-10080) — WorkoutKit のカスタムトレーニング構造と CMBatchedSensorManager との組み合わせ
- [What's new in HealthKit](/articles/wwdc2023-10082) — HealthKit の新機能、運動データの保存と共有
- [Meet Core ML Tools](/articles/wwdc2023-233) — 高周波センサーデータを機械学習モデルのトレーニングに使う
