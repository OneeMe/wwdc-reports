...
- **AVIF**：AV1 動画エンコード使用、JPEG 比最大 10 倍小さく、モダン形式で最も広いブラウザサポート
...
Managed Media Source の詳細を自前処理したくない場合は HLS.js を使用:
...
キーポイント:
- HLS.js は Safari 17 で自動的に Managed Media Source を使用
...
- **やること**：WKWebView アプリで HEIC 画像を直接使用
  - **価値**：iPhone 撮影は HEIC がデフォルト、変換不要でハードウェア加速表示
  - **始め方**：HEIC ファイルを画像ソースに直接使用、Safari 17 の WKWebView がネイティブサポート

## 関連セッション

- [What's new in CSS](/articles/wwdc2023-10167) — Safari 17 の新しい CSS 機能
- [Rediscover Safari developer features](/articles/wwdc2023-10121) — Managed Media Source を試すための機能フラグの有効化
- [Meet Web Push for Safari](/articles/wwdc2023-10120) — Safari の Web Push 新機能
