...
- [What's new in Wallet](/articles/wwdc2025-272) — 社員証、Access Key、Wallet pass の最新機能。Tap to Login の土台になります。
- [Meet the Identity Documents API](/articles/wwdc2025-261) — Wallet Access Key と企業 ID 文書を支える基盤の解説。
