...
relatedSessions:
  ...
  - title: "Integrate your app with Productivity broadcasts"
    code: "10420"
    description: "ブロードキャストで翻訳タスクなどの自動化シナリオをトリガー"
---
...
- [What's new in Foundation](/articles/wwdc2024-10103) — Locale.Language など Foundation 言語処理 API
- [Integrate your app with Productivity broadcasts](/articles/wwdc2024-10420) — ブロードキャストで翻訳タスクなどの自動化シナリオをトリガー
