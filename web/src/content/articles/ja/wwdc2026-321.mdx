...
- [Compose custom layouts with SwiftUI](/articles/wwdc2022-10056) - ジオメトリ変化コールバックの代わりにカスタム Layout を使います
- [Stacks, Grids, and Outlines in SwiftUI](/articles/wwdc2020-10031) - SwiftUI レイアウトの基礎であり、この session の前提知識です
