...
入り口：`NSClickGestureRecognizer`、`NSPanGestureRecognizer`、`NSControl.addTarget(_:action:for:)`
...
入り口：`window.isRestorable = true`、`encodeRestorableState(with:)`、`restoreWindow(withIdentifier:state:completionHandler:)`
