...
- [ARKit でジオメトリ対応オーディオを発見する](/articles/wwdc2021-10079) — ARKit のジオメトリ対応オーディオ
- [Render with Metal](https://developer.apple.com/videos/play/wwdc2019/601/) — メタル レンダリング パイプライン、Custommaterial のシェーダー作成の基礎
