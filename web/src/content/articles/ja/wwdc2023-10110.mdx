...
relatedSessions:
  ...
  - title: "Take SwiftUI to the next dimension"
    code: "10113"
    description: "SwiftUI で 3D コンテンツを使う"
  - title: "Go beyond the window with SwiftUI"
    code: "10111"
    description: "Immersive Space でアプリを拡張する"
  - title: "Meet UIKit for spatial computing"
    code: "111215"
    description: "visionOS における UIKit の適応"
---
...
- [Take SwiftUI to the next dimension](/articles/wwdc2023-10113) — SwiftUI での 3D コンテンツと Volume
- [Go beyond the window with SwiftUI](/articles/wwdc2023-10111) — Immersive Space で没入型空間体験を作成
- [Meet UIKit for spatial computing](/articles/wwdc2023-111215) — UIKit ベースのアプリの visionOS 適応
