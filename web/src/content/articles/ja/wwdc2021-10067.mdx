...
- [Game Center でリアルタイムおよびターンベースのマルチプレイヤーをサポート](/articles/wwdc2020-10619) — マルチプレイヤー ゲーム技術の詳細な説明
- [Game Center を利用する: リーダーボード、実績、マルチプレイヤー](/articles/wwdc2020-10619) — リーダーボードと実績の完全ガイド (2020)
