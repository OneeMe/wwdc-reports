...
- [Discover Apple-Hosted Background Assets](/articles/wwdc2025-325) — Apple-Hosted Background Asset のアップロードとバージョン管理。本 session で言及した第 4 の webhook イベントはここから来ています。
