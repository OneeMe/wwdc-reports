...
- [What's new in App Store Connect](/articles/wwdc2020-10651) — App Store Connect の新機能。App Clip 体験の設定を含む
- [Configure and link your App Clips](/articles/wwdc2020-10146) — App Clip の設定とリンクの詳細
- [What's new in Universal Links](/articles/wwdc2020-10098) — App Clip のドメイン検証に関連するユニバーサルリンクの新機能
