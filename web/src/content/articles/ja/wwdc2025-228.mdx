...
date: 2026-06-10
tags: ["Privacy & Security", "System Services"]
...
relatedSessions:
  - title: "Meet AccessorySetupKit"
    code: "10203"
    year: "2024"
    description: "WWDC24 のアクセサリペアリングフロー公式セッション。本セッションの Wi-Fi Aware ペアリング経路と直接対応します。"
  - title: "What's new in Network framework"
    code: "234"
    description: "Network framework の新機能。Wi-Fi Aware の Listener / Browser / Connection はこれらの上に構築されています。"
  - title: "Integrate privacy into your development process"
    code: "246"
    description: "app 設計段階でプライバシーと権限をプロセスに組み込む方法。Wi-Fi Aware のペアリング認可モデルと相性がよい内容です。"
---
