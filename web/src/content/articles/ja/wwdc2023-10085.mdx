...
relatedSessions:
  ...
  - title: "Build spatial SharePlay experiences"
    code: "10087"
    description: "GroupActivities フレームワークを使って空間共有体験を構築します。"
  - title: "Meet Reality Composer Pro"
    code: "10083"
    description: "Reality Composer Pro 入門：3D シーンコンテンツを作成します。"
  - title: "Meet ARKit for spatial computing"
    code: "10082"
    description: "visionOS 上の ARKit の新 API により、3D コンテンツのトラッキングをサポートします。"
---
