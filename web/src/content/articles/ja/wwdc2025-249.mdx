...
date: 2026-06-10
tags: ["アプリサービス", "App Store", "Distribution & Marketing"]
...
- [Explore App Store server APIs for In-App Purchase](/articles/wwdc2024-10062) — WWDC24 のサーバ API 入門編。本セッションの前提知識として併読すると効果的です。
