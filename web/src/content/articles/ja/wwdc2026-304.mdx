...
- [Video Formats を使って高品質な写真をキャプチャする](/articles/wwdc2026-305) - Core Image の RAW 処理。この session の RAW/ProRAW 撮影の話につながる
- [よりレスポンシブなカメラ体験を作る](/articles/wwdc2026-268) - Instruments の応答性分析ツール。304 で扱う遅延処理とレスポンシブシャッターの実際の効果を測定できる
